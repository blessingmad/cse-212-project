public static class UniqueLetters
{
    public static void Run()
    {
        ...
        Console.WriteLine(AreUniqueLettersAlternate(test1)); // Uncomment if you want to test alternate method

        var test2 = "abcdefghjiklanopqrstuvwxyz"; // Expect False because 'a' is repeated
        Console.WriteLine(AreUniqueLetters(test2));
        Console.WriteLine(AreUniqueLettersAlternate(test2)); // Uncomment if you want to test alternate method

        var test3 = "";
        Console.WriteLine(AreUniqueLetters(test3)); // Expect True because its an empty string
        Console.WriteLine(AreUniqueLettersAlternate(test3)); // Uncomment if you want to test alternate method
    }
